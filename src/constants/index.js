// ✅ FIXED VERSION OF index.js (usually src/constants/index.js)
...
const projects = [
  ...
  },
  {
    name: "Simple Chatbot",
    description:
      "This is a simple Q/A chatbot designed to answer a predefined set of questions. It works on a conversational model, interpreting short user inputs effectively.",
    tags: [
      { name: "Python", color: "blue-text-gradient" },
  ...
  },
  {
    name: "EduVision",
    description:
      "EduVision is a mini-ERP for government primary schools, managing attendance, marks, and student data. It supports role-based access and centralized monitoring.",
    tags: [
      { name: "Node", color: "blue-text-gradient" },
      { name: "Express", color: "white-text-gradient" },
      { name: "Ember", color: "pink-text-gradient" },
